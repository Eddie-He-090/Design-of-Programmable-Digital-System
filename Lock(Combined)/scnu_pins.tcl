...
#set_location_assignment PIN_71 -to pwmout
#seg7
#set_location_assignment PIN_65 -to seg7com0
...
#key
set_location_assignment PIN_88 -to s2
set_location_assignment PIN_89 -to s3
set_location_assignment PIN_90 -to s4
#set_location_assignment PIN_90 -to rst
set_location_assignment PIN_91 -to s5
set_location_assignment PIN_72 -to s6
